...
# Latest release is 1.0.4.1 (2015-10-19) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.4.1/lavagna-1.0.4.1-distribution.zip
unzip lavagna-1.0.4.1-distribution.zip
./lavagna-1.0.4.1/bin/lavagna.sh
```
