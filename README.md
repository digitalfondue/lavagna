...
# Latest release is 1.0.6.1 (2016-03-25) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.6.1/lavagna-1.0.6.1-distribution.zip
unzip lavagna-1.0.6.1-distribution.zip
./lavagna-1.0.6.1/bin/lavagna.sh
```
