...
# Latest release is 1.0.6.2 (2016-03-28) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.6.2/lavagna-1.0.6.2-distribution.zip
unzip lavagna-1.0.6.2-distribution.zip
./lavagna-1.0.6.2/bin/lavagna.sh
```
