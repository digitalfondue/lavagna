...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.5.2/lavagna-1.0.5.2-distribution.zip
unzip lavagna-1.0.5.2-distribution.zip
./lavagna-1.0.5.2/bin/lavagna.sh
```
