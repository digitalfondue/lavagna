...
# Latest release is 1.0.4 (2015-09-15) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.4/lavagna-1.0.4-distribution.zip
unzip lavagna-1.0.4-distribution.zip
./lavagna-1.0.4/bin/lavagna.sh
```
