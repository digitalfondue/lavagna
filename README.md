...
# Latest release is 1.0.3 (2015-09-01) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.3/lavagna-1.0.3-distribution.zip
unzip lavagna-1.0.3-distribution.zip
./lavagna-1.0.3/bin/lavagna.sh
```
