...
# Latest release is 1.0.5 (2015-11-07) #
...
```
wget https://repo1.maven.org/maven2/io/lavagna/lavagna/1.0.5/lavagna-1.0.5-distribution.zip
unzip lavagna-1.0.5-distribution.zip
./lavagna-1.0.5/bin/lavagna.sh
```
