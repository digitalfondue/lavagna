...
CREATE TABLE LA_PROJECT_MAIL_TICKET_CONFIG (
    ...
    MAIL_CONFIG_LAST_CHECKED TIMESTAMP NULL DEFAULT NULL,
...
-- CONSTRAINTS
ALTER TABLE LA_PROJECT_MAIL_TICKET ADD FOREIGN KEY(MAIL_TICKET_PROJECT_ID_FK) REFERENCES LA_PROJECT(PROJECT_ID);
ALTER TABLE LA_PROJECT_MAIL_TICKET ADD FOREIGN KEY(MAIL_TICKET_BOARD_ID_FK) REFERENCES LA_BOARD(BOARD_ID);
...
ALTER TABLE LA_PROJECT_MAIL_TICKET ADD CONSTRAINT UNIQUE_LA_PROJECT_MAIL_TICKET_NAME UNIQUE(MAIL_TICKET_NAME, MAIL_TICKET_PROJECT_ID_FK);
