(function() {
	...
	module.run(function($rootScope, $state, $window) {
		...
		$rootScope.oauth = {baseUrl : $window.location.origin + $window.location.pathname.replace(/setup\/$/, '')};
	...
	function goToRootApp() {
		window.location.href = window.location.origin + window.location.pathname.replace(/setup\/$/, '');
	}
	...
	module.controller('SetupCtrl', function($window, $rootScope, $scope, $http, $state) {
		...
		$scope.baseUrlPlaceholder = $window.location.origin + window.location.pathname.replace(/setup\/$/, '');
	...
	module.controller('SetupUserCtrl', function($window, $scope, $rootScope, $http, $state) {
		...
		$scope.saveUser = function() {
			$rootScope.toSave.user = {provider : $scope.accountProvider, username : $scope.username, enabled : true, roles : ['ADMIN']};
	...
	module.controller('SetupActivationCtrl', function($window, $scope, $http, $state) {
		$scope.activate = function() {
			var configToUpdate = [{first : 'SETUP_COMPLETE', second : 'true'}].concat($scope.toSave.first, $scope.toSave.second);
