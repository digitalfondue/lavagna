...
public interface CardQuery {
	...
	List<CardFull> fetchAllOpenCardsByUserId(@Bind("userId") int userId, @Bind("amount") int amount,
	...
	List<CardFull> fetchAllOpenCardsByProjectIdAndUserId(@Bind("userId") int userId,
